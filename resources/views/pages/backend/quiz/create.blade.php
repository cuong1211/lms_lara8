    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel-body">
                ...
                <!-- New Task Form -->
                <form action="{{ url('/admin/course') . '/' . $course->id . '/createquiz' }}" method="POST"
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#add_question").click(function() {
                $('#index' + i).html('<td><label for="question[' + i + '][question-text]">Question ' + i +
                    ...
                    i +
                    '][answers][1]">Answer 1</label><input type="text" class="form-control" name="question[' +
                    i + '][answers][1]" id="question[' + i +
                    '][answers][1]" aria-describedby="question[' + i +
                    '][answers][1]" placeholder="Enter answer" required></div><div class="form-check"><label for="question[' +
                    i +
                    ...
                    '][answers][1][is_correct]" value="true" checked>Correct?</label></div></td><td><div class="form-group"><label for="question[' +
                    i +
                    '][answers][2]">Answer 2</label><input type="text" class="form-control" name="question[' +
                    i + '][answers][2]" id="question[' + i +
                    '][answers][2]" aria-describedby="question[' + i +
                    '][answers][2]" placeholder="Enter answer" required></div><div class="form-check"><label for="question[' +
                    i +
                    '][answers][is_correct]" class="form-check"><input type="radio" class="form-check-input" name="question[' +
                    i + '][answers][is_correct]" id="question[' + i +
                    '][answers][2][is_correct]" value="true">Correct?</label></div></td><td><div class="form-group"><label for="question[' +
                    i +
                    '][answers][3]">Answer 3</label><input type="text" class="form-control" name="question[' +
                    i + '][answers][3]" id="question[' + i +
                    '][answers][3]" aria-describedby="question[' + i +
                    '][answers][3]" placeholder="Enter answer" required></div><div class="form-check"><label for="question[' +
                    i +
                    '][answers][is_correct]" class="form-check-label"><input type="radio" class="form-check-input" name="question[' +
                    i + '][answers][is_correct]" id="question[' + i +
                    '][answers][3][s_icorrect]" value="true">Correct?</label></div></td><td><div class="form-group"><label for="question[' +
                    i +
                    '][answers][4]">Answer 4</label><input type="text" class="form-control" name="question[' +
                    i + '][answers][4]" id="question[' + i +
                    '][answers][4]" aria-describedby="question[' + i +
                    '][answers][4]" placeholder="Enter answer" required></div><div class="form-check"><label for="question[' +
                    i +
                    '][answers][is_correct]" class="form-check-label"><input type="radio" class="form-check-input" name="question[' +
                    i + '][answers][is_correct]" id="question[' + i +
                    '][answers][4][is_correct]" value="true">Correct?</label></div></td></tr></tbody></table></td><td id="DeleteQuestionWrapper' +
                    i + '"><button class="btn btn-danger row-delete" id="DeleteQuestion' + i +
                    '">Delete Question</button></td>');
