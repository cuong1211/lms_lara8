    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">ZOOM</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <form class="form-horizontal" action="{{ url('/admin/creatmeetings') }}" method="POST">
                @csrf
                ...
                <div class="form-group" style="display:none">
                    ...
                    <input class="form-control" id="example-date" type="date" name="type"value="1">
                </div>
                <div class="form-group" >
